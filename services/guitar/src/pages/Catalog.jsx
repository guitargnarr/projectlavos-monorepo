      ...
      <div className="mb-8 space-y-4">
        ...
        <div>
          <input
            ...
            className="w-full md:w-96 px-4 py-3 text-base bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-green-500 transition-colors"
          />
        </div>
